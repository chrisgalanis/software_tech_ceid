...
public class AuthenticateHouseAdapter
  ...
  public AuthenticateHouseAdapter(List<HouseListing> listings, OnActionListener listener) {
  ...
  public void onBindViewHolder(@NonNull ViewHolder h, int position) {
    ...
    // Owner avatar
    Glide.with(h.itemView).load(listing.ownerAvatarUrl).circleCrop().into(h.ivOwnerProfile);
