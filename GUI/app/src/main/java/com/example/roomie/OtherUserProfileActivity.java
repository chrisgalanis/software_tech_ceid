...
public class OtherUserProfileActivity extends AppCompatActivity {
  ...
  private void loadProfile() {
    ...
    tvInterests.setText(ints.isEmpty() ? "—" : android.text.TextUtils.join(", ", ints));

    // 4) View house button (stub)
    btnViewHouse.setOnClickListener(
        v -> {
          ...
          if (houseId != -1) {
            ...
            Toast.makeText(this, "This user doesn’t have a house listing", Toast.LENGTH_SHORT)
                .show();
          }
        });
    ...
    builder.setPositiveButton(
        ...
        (dialog, which) -> {
          ...
          if (reportText.isEmpty()) {
            Toast.makeText(this, "Report text cannot be empty", Toast.LENGTH_SHORT).show();
          } else {
