...
public class ChatMessage {
    ...
    public ChatMessage(String senderId, String receiverId, String messageText, String timestamp, boolean isSentByCurrentUser) {
    ...
    public ChatMessage(String senderId, String receiverId, String messageText, String timestamp, boolean isSentByCurrentUser, int senderProfileImageRes) {
        this.senderId = senderId;
        this.receiverId = receiverId;
        this.messageText = messageText;
        this.timestamp = timestamp;
