...
public class AuthenticateListingsActivity extends AppCompatActivity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    AdminNavigationHelper.setup(findViewById(R.id.bottom_navigation), this, R.id.nav_home);
  }
  ...
  public void onApprove(HouseListing listing) {
    ...
    if (ok) {
      ...
      Toast.makeText(this, "Approved listing at " + listing.house.address, Toast.LENGTH_SHORT)
          .show();
    } else {
  ...
  public void onDisapprove(HouseListing listing) {
    ...
    Toast.makeText(this, "Disapproved listing at " + listing.house.address, Toast.LENGTH_SHORT)
        .show();
  }
