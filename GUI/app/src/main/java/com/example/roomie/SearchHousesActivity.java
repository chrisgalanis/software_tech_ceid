...
public class SearchHousesActivity extends AppCompatActivity
  ...
  public void onMapReady(GoogleMap googleMap) {
    ...
    if (!houses.isEmpty()) {
      map.moveCamera(CameraUpdateFactory.newLatLngZoom(houses.get(0).location, 12f));
    }
  }
  ...
  public List<House> getMockHouses() {
    return Arrays.asList(
        new House(
            ...
            88,
            3,
            Arrays.asList("https://ex.com/1.jpg", "https://ex.com/2.jpg"),
            "KwstasMav",
            "avatarURL",
        ...
        new House(
            ...
            95,
            2,
            Arrays.asList("https://ex.com/a1.jpg", "https://ex.com/a2.jpg"),
            "whodis",
            "avatarURL",
        ...
        new House(
            ...
            109,
            4,
            Arrays.asList("https://ex.com/b1.jpg", "https://ex.com/b2.jpg"),
            "mikethefreak",
            "avatarURL",
